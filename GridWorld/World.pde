    ...
    class World {        
        ...
        public World() {
            ...
            //    }
            //}
            //this.species.add(new Species(this, Settings.NUM_CREATURES_PER_SPECIES, spawn0, brain0, num_additional_inputs, num_memory, num_outputs));
